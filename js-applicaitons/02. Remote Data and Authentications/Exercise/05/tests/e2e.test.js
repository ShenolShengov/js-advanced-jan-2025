...
describe('E2E tests', function () {
    ...
    describe('Authentication', () => {
        ...
        it('login makes correct API call', async () => {
            ...
            const [request] = await Promise.all([onRequest(), page.click('form >> text=Login', { timeout: interval })]);
        ...
        it('logout makes correct API call', async () => {
            ...
            const [request] = await Promise.all([onRequest(), page.click('nav >> text=Logout', { timeout: interval })]);
    ...
    describe('CRUD', () => {
        ...
        it('create makes correct API call for logged in user', async () => {
            ...
            const [request] = await Promise.all([onRequest(), page.click('fieldset >> .add', { timeout: interval })]);
